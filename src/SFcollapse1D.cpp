...
#include "logo.hpp"
/*
//checar a existência de um arquivo na pasta out. se existir executar o comando abaixo, caso contrario prosseguir.
char CHKP ;
cout << "Use previous execution as checkpoint? y/n  \n" << endl;
scanf ('%c',CHKP);

if (CHKP =='y'){
  cout << 'Executing code from last checkpoint' << endl;
}else if(CHKP =='n')



*/
  //primeira coisa é receber do usuario se deseja checkpoint
